...
const logo = await readFile(
  new URL("../public/images/dyuteralogo-transparent.png", import.meta.url),
);
const escape = (text) =>
  text.replace(
    /[&<>"']/g,
...
try {
  ...
  *{box-sizing:border-box}body{margin:0;background:#090a10;color:#eeeaf7;font-family:Manrope;overflow:hidden}
  ...
  header{display:flex;align-items:center}header img{width:100px;height:100px}
  small{display:block;margin:26px 0 20px;color:#a58bc5;font-size:14px;letter-spacing:4px}h1{font-size:75px;line-height:1.22;letter-spacing:-3px;margin:0;font-weight:600}h1 span{color:#b69bff}
  ...
  </style></head><body><main><header><img src="data:image/png;base64,${logo.toString("base64")}" alt="${escape(site.name)}" /></header><small>YOUR IDEAS. OUR ENGINEERING.</small><h1>Ideas into impact.<br><span>Built with purpose.</span></h1><p>${escape(site.tagline)}</p><div class="orbit"></div></main></body></html>`);
